...
class OpMakeGreatFocus : SpellAction{
    ...
    override fun execute(args: List<Iota>, ctx: CastingContext): Triple<RenderedSpell, Int, List<ParticleSpray>>? {
        ...
        val item=stack.item
        if(item is GreatFocus<*> && item.canWriteEntity(stack,target)){
    ...
    private data class Spell<T: Iota>(val stack: ItemStack, val item: GreatFocus<T>, val target: Entity) : RenderedSpell {
